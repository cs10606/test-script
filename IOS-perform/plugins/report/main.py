...
class Report(object):
    ...
    def readPerfermaceSample(self, filename):
        ...
        try:
            ...
            for item in rdata:
                ...
                for k in keys:
                    v = item[k]
                    v = v.encode('utf-8') if type(v) is str else v
                    if k == 'Date':
                        v = datetime.datetime.strptime(v, '%Y-%m-%d %H:%M:%S:%f')
                    nitem[k] = v
                samples.append(nitem)
        except Exception as e:
            print("Exception readPerfermaceSample: %s" % str(e))
            return False
        return samples
    ...
    def readNetworkSample(self, filename):
        ...
        try:
            ...
            print("Exception readNetworkSample: %s" % str(e))
            return False
        return samples
    ...
    def readFpsSample(self, filename):
        ...
        try:
            ...
            print("Exception readFpsSample: %s" % str(e))
            return False
        return samples
    ...
    def readCrash(self):
        ...
        for filename in os.listdir(d):
            ...
            try:
                ...
                print("Exception readCrash: %s" % str(e))
                continue
        return crash
    ...
    def readMatchImages(self, dirname):
        ...
        for filename in os.listdir(dirname):
            ...
            try:
                ...
                print("Exception readMatchImages: %s" % str(e))
                continue
        return images
    ...
    def generate(self):
        try:
            ...
            print("Exception generate: %s" % str(e))
            return False
        return True
...
def main():
    ...
    # result_dir='/Users/dengtacj/AutoTest/ios-perform/log/20161212_164832'
